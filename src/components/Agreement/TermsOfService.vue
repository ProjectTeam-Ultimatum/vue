...
본 약관은 한국관광공사(이하 "공사")가 제공하는 VisitKorea 서비스(이하 "서비스")의 이용과 관련하여 공사와 이용자의 권리, 의무 및 책임사항 그리고 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
...
① 이용자: 공사가 제공하는 서비스를 받는 회원 및 비회원
② 회원: 공사와 서비스 이용계약을 체결하고 이용자 아이디(ID)를 부여 받은 개인이나 법인 또는 법인에 준하는 단체
③ 비회원: 회원에 가입하지 않고 공사가 제공하는 서비스를 이용하는 자
④ 아이디(ID): 회원식별과 회원의 서비스 이용을 위하여 회원이 설정하고 공사가 승인하는 문자 또는 숫자의 조합
...
이용자는 회원가입을 신청하려면 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고, 공사는 이러한 신청에 대하여 승낙함으로써 회원가입이 됩니다.
...
제 6 조 (회원 탈퇴 및 자격상실, 서비스 이용제한 등)  <br/>

① 회원은 탈퇴를 희망할 경우 탈퇴를 요청할 수 있으며, 공사는 관련법 등이 정하는 바에 따라 이를 처리합니다. 회원이 자발적으로 계약을 해지할 경우, 공사는 관련법 및 개인정보취급방침에 따라 회원정보를 삭제합니다. 회원이 다음 각 호의 사유에 해당하는 경우, 공사는 회원자격을 제한 및 정지시킬 수 있습니다.

    1. 가입 신청 시에 허위 내용을 등록한 경우
    2. 다른 사람의 서비스 이용을 방해하거나 타인의 명예를 훼손하거나 그 정보를 도용하는 등 전자 거래 및 정보통신서비스 이용질서를 위협하는 경우
    3. 제공되는 정보를 변경하는 등 공사의 운영을 방해한 경우
...
② 공사는 회원이 서비스에 게시, 게재하거나 서비스를 통해 전송, 수신한 내용물 및 그 결과에 대하여 책임지지 않으며, 아래사항에 해당하는 경우 게시물을 임의로 삭제할 수 있습니다.
    ...
    5. 공사의 지적재산권, 타인의 지적재산권 등 기타 권리를 침해하는 내용인 경우
...
본 약관에 명시되지 않은 사항에 대해서는 관련법령에 의하고, 법에 명시되지 않은 부분에 대하여는 관습에 의합니다.</p>
      <!-- 약관 내용 계속 -->
